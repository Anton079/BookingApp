...
namespace Booking_App.Users.Models
{
    public class Customer : User
    {
        ...
        public Customer(int id, string type, string firstName, string lastName, string email, string password, int phone, string preferredPaymentMethod, int membershipLevel)
